    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header ">
                <form name="formSearch" id="formSearch" method="post" action="{{ route('users.search') }}">
                    @csrf
                    {!! Form::hidden('page', 0, ['id' => 'page']) !!}
                    {!! Form::hidden('filter_take', 20, ['id' => 'filter_take']) !!}
                    <div class="d-flex justify-content-between">
                        <div class="" style="min-width: 300px;">
                            <input type="text" class="form-control" placeholder="Nome ou email do usuário"
                                name="filter_name">
                        </div>
                        <div class="d-flex justify-content-end gap-2" style="min-width: 400px;">
                            ...
                            <button type="button" class="btn btn-sm btn-primary"
                                onclick="Tela.abrirJanela('{{ route('users.create') }}', 'Novo Usuário', 'md')">
