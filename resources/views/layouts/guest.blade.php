...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style customizer-hide" dir="ltr"
    data-theme="theme-default" data-assets-path="{{ asset('/') }}" data-template="horizontal-menu-template">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pages/page-auth.css') }}" class="template-customizer-core-css" />
